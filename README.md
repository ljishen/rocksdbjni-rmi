...
```bash
wget https://oss.sonatype.org/service/local/repositories/releases/content/com/github/ljishen/rocksdbjni-rmi/0.0.0.4/rocksdbjni-rmi-0.0.0.4.jar
java -jar rocksdbjni-rmi-0.0.0.4.jar [port] [hostname]
```
