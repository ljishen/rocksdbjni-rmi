...
```bash
wget https://oss.sonatype.org/service/local/repositories/releases/content/com/github/ljishen/rocksdbjni-rmi/0.0.0.5/rocksdbjni-rmi-0.0.0.5.jar
java -jar rocksdbjni-rmi-0.0.0.5.jar [port] [hostname]
```
